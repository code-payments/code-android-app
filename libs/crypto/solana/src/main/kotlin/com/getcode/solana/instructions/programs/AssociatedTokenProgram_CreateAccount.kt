...
data class TimelockAccounts(val state: com.getcode.solana.keys.PublicKey, val vault: com.getcode.solana.keys.PublicKey)
...
class AssociatedTokenProgram_CreateAccount(
    val subsidizer: com.getcode.solana.keys.PublicKey,
    val owner: com.getcode.solana.keys.PublicKey,
    val associatedTokenAccount: com.getcode.solana.keys.PublicKey,
