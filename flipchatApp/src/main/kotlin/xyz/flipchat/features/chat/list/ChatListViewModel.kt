...
class ChatListViewModel @Inject constructor(
    ...
    sealed interface Event {
        ...
        data class ShowFullScreenSpinner(val showScrim: Boolean = true, val showSpinner: Boolean = true) : Event
    ...
    init {
        ...
        eventFlow
            ...
            .onEach { dispatchEvent(Event.ShowFullScreenSpinner(showScrim = true, showSpinner = false)) }
        ...
        paymentController.eventFlow
            ...
            .onEach { dispatchEvent(Event.ShowFullScreenSpinner(showScrim = false, showSpinner = false)) }
            .launchIn(viewModelScope)
        ...
        paymentController.eventFlow
            ...
            .onResult(
                onError = {
                    dispatchEvent(Event.ShowFullScreenSpinner(showScrim = false, showSpinner = false))
