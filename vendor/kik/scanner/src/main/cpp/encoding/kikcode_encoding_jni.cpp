...
#include "../scan/kikcode_constants.h"
#include <sstream>
#include <iostream>
#include <iomanip>
...
extern "C" {
    ...
    jobject Java_com_kik_scan_KikCode_parse(JNIEnv *env, jobject clzz, jbyteArray data)
    {
    ...
    jbyteArray Java_com_kik_scan_UsernameKikCode_encode(JNIEnv *env, jobject thiz)
    {
    ...
    jbyteArray Java_com_kik_scan_GroupKikCode_encode(JNIEnv *env, jobject thiz)
    {
        jbyteArray result_array = nullptr;
        unsigned char out_data[KIK_CODE_TOTAL_BYTE_COUNT];
    ...
    jbyteArray Java_com_kik_scan_RemoteKikCode_encode(JNIEnv *env, jobject thiz)
    {
        jbyteArray result_array = nullptr;
        unsigned char out_data[KIK_CODE_TOTAL_BYTE_COUNT];
