...
data class ResolvedUserFlags(
    ...
    val preferredOnRampProvider: ResolvedFlag<OnRampProvider?>,
    val supportedOnRampProviders: ResolvedFlag<List<OnRampProvider>>,
...
internal fun UserFlags.resolve(overrides: Overrides): ResolvedUserFlags = ResolvedUserFlags(
    ...
    preferredOnRampProvider = ResolvedFlag(preferredOnRampProvider, overrides.preferredOnRampProvider),
    supportedOnRampProviders = ResolvedFlag(supportedOnRampProviders, overrides.supportedOnRampProviders),
