...
/**
 * Which bubble in a run wears the name and the picture.
 *
 ...
 * the one whose upper neighbour is someone else, a date separator, or nothing.
 */
class SenderRunTest {
    ...
    private fun bubble(sender: SenderIdentity?, isFromSelf: Boolean = false) =
