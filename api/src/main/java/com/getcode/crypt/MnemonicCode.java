...
public class MnemonicCode {
    public static final String TAG = "MnemonicCode";
    ...
    public MnemonicCode(Resources resources) throws IOException {
        this(openDefaultWords(resources), BIP39_ENGLISH_SHA256);
    }

    private static InputStream openDefaultWords(Resources resources) throws IOException {
        if (resources == null) return null;
        InputStream stream = resources.openRawResource(R.raw.english);
        if (stream == null)
