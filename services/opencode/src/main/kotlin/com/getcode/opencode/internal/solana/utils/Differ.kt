...
internal fun printDiff(title: String, one: String, two: String) {
    printDiff(title, listOf(one), listOf(two))
}

internal fun printDiff(title: String, one: List<String>, two: List<String>) {
    val lineSeparator = "\n -\n"
...
internal fun printMatch(title: String) {
    Timber.d("✓ $title")
}