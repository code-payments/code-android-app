...
sealed interface OutgoingMessageContent {
    ...
    data class Reply(val messageId: ID, val text: String, val intentId: ID? = null): OutgoingMessageContent
    data class Reaction(val messageId: ID, val emoji: String, val intentId: ID? = null): OutgoingMessageContent
