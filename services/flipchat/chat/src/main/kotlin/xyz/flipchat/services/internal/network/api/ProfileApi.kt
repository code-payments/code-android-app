...
import xyz.flipchat.services.internal.network.extensions.linkingToken
...
class ProfileApi @Inject constructor(
    ...
    ): Flow<ProfileService.LinkSocialAccountResponse> {
        val apiRequest = LinkSocialAccountRequest.newBuilder()
